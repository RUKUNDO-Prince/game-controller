...
#
# # Initialize joystick if at least one joystick is detected
...
#
#     # Joystick control
#     if joysticks and joystick.get_numaxes() >= 2:
#         x_axis = joystick.get_axis(0)
#         if x_axis < -0.5 and player.rect.center[0] > left_lane:
#             player.rect.x -= 100
#         elif x_axis > 0.5 and player.rect.center[0] < right_lane:
#             player.rect.x += 100
#
...
while running:
    ...
    # Joystick control (moved outside the event loop)
    if joysticks and joystick.get_numaxes() >= 2:
        x_axis = joystick.get_axis(0)
        if x_axis < -0.5 and player.rect.center[0] > left_lane:
            player.rect.x -= 100
